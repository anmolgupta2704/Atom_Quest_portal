...
export default function Login({ onLogin }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 460, padding: '20px' }}>
        {/* Logo */}
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ color: 'var(--text2)', fontSize: '0.9rem' }}>Goal Setting & Tracking Portal</p>
        </div>

        {/* Login Card */}
        <div style={{
          background: 'var(--card)', border: '1px solid var(--border)',
          borderRadius: 20, padding: '36px', boxShadow: '0 8px 40px rgba(0,0,0,0.5)',
        }}>
          <h2 style={{ fontSize: '1.1rem', fontWeight: 600, marginBottom: 24 }}>Sign In</h2>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input
                ...
                placeholder="you@atomquest.in" required
              />
            </div>
            <div className="form-group">
          ...
          <div style={{ marginTop: 28 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              ...
              <span style={{ color: 'var(--text3)', fontSize: '0.75rem', fontWeight: 500 }}>Demo Access</span>
              <div style={{ flex: 1, height: 1, background: 'var(--border)' }} />
            </div>
              ...
              {DEMO_CREDS.map(cred => (
                <button key={cred.role} onClick={() => quickLogin(cred)}
                  style={{
                    ...
                    background: `rgba(${cred.color === '#3b82f6' ? '59,130,246' : cred.color === '#10b981' ? '16,185,129' : '139,92,246'},0.1)`,
                    border: `1px solid ${cred.color}33`,
                    color: cred.color, fontFamily: 'var(--font)',
        ...
        <p style={{ textAlign: 'center', marginTop: 20, color: 'var(--text3)', fontSize: '0.75rem' }}>
